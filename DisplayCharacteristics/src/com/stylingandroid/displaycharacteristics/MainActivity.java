...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		populate(findViewById(R.id.main), getWindowManager().getDefaultDisplay());
	}
	...
	private static void populate(View v, Display display) {
		...
		if (actual != null) {
			actual.setText(String.format("%dx%d", metrics.widthPixels, metrics.heightPixels));
		}
		...
		if (dp != null) {
			dp.setText(String.format("%dx%d", ((int) (metrics.widthPixels / density)),
